  ...
  return (
    <MainLayout>
      <form className="px-96 py-16 flex flex-col gap-11">
        ...
        <Link to={'/'} className="px-5 py-3 bg-dorado text-vivvi font-roboto text-xl rounded-full border border-vivvi w-5/12 text-center">Empezar</Link>
      </form>
    </MainLayout>
  )
}
