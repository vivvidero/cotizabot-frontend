...
export const AdminSpaceBathRoomWithShower: FC<Props> = ({ space }) => {
    ...
    return (
        <>
            <h3 className='font-roboto text-xl text-vivvi font-semibold mb-4'> Baño {space.roomNumber === 1 ? '' : space.roomNumber} (con ducha) </h3>
            {
                        ...
                        <div key={tipology}>
                            ...
                            <div className='flex gap-6 mt-4'>
                                ...
                                <div className='w-8/12 flex flex-col gap-2'>
                                    ...
                                    <label className=" p-2 bg-white border border-platinum">
                                        <input type="text" name={"shower"} id={tipology.toString()} className="w-full" placeholder='Ducha' defaultValue={newProject.spaces.filter(spa => spa.name === space.name)[0]?.tipologies.filter((typo) => typo.id === tipology)[0]?.shower} onChange={handleBathRoom} />
                                    </label>
                                    <label className=" p-2 bg-white border border-platinum">
